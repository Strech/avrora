defmodule Avrora.Config do
  ...
  ## Options:
      ...
      * `decode_hook` function to amend decoded payload, default `fn _, _, data, fun -> fun.(data) end`
  ...
  @callback decode_hook :: (any(), any(), any(), any() -> any())
  ...
  @doc false
  def decode_hook, do: get_env(:decode_hook, fn _, _, data, fun -> fun.(data) end)
